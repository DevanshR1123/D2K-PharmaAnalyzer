...
# Load a model
model = YOLO('/Users/visheshmistry/Documents/D2K/runs/detect/train7/weights/best.pt')

# Run batched inference on a list of images
results = model.predict(['datasets/valid/images/WhatsApp-Image-2024-02-05-at-8-45-47-PM_jpeg.rf.65894a3767b8950803aa680cc5b0afab.jpg'], save=True, show_labels=True, show_boxes=True)  # return a list of Results objects
...
def assess_lighting_conditions(image, target_region):
    ...
    gray = cv2.cvtColor(target_region_img, cv2.COLOR_BGR2GRAY)
...
image = cv2.imread("datasets/valid/images/WhatsApp-Image-2024-02-05-at-8-45-47-PM_jpeg.rf.65894a3767b8950803aa680cc5b0afab.jpg")
target_medicine_template = cv2.imread("/Users/visheshmistry/Documents/D2K/runs/detect/predict/crops/pantop-d/WhatsApp-Image-2024-02-05-at-8-45-47-PM_jpeg.rf.65894a3767b8950803aa680cc5b0afab.jpg", cv2.IMREAD_GRAYSCALE)

# Example usage
visibility_percentage = calculate_visibility_percentage(image, target_medicine_template)
placement_analysis_percentage = calculate_placement_analysis_percentage(image, target_medicine_template)
lighting_conditions = assess_lighting_conditions(image, (x, y, w, h))  # Replace (x, y, w, h) with the actual coordinates of the detected medicine
...
incentive_percent = ((visibility_percentage + placement_analysis_percentage + lighting_conditions)*10000)/280
